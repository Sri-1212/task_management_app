...
const generateAccessToken = (payload) => {
    return jsonwebtoken_1.default.sign(payload, env_1.config.jwtAccessSecret, {
        expiresIn: env_1.config.jwtAccessExpires,
    });
};
exports.generateAccessToken = generateAccessToken;
const generateRefreshToken = (payload) => {
    return jsonwebtoken_1.default.sign(payload, env_1.config.jwtRefreshSecret, {
        expiresIn: env_1.config.jwtRefreshExpires,
    });
};
